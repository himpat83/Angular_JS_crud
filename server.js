...
app.put('/contactlist/:id', function(req, res) {
    ...
    db.contactlist.findAndModify({ query: { _id: mongojs.ObjectId(id) }, update: { $set: { empid: req.body.empid, empname: req.body.empname, empbdate: req.body.empbdate } }, new: true }, function(err, doc) {
        res.json(doc);
    });
});
